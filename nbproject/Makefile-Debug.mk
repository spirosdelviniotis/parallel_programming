...
${OBJECTDIR}/MPI/MPI_main.o: MPI/MPI_main.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -include . -include CUDA/common/inc/lcutil.h -include CUDA/common/inc/timestamp.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MPI/MPI_main.o MPI/MPI_main.c

${OBJECTDIR}/MPI_Heat_2D/mpi_heat2D.o: MPI_Heat_2D/mpi_heat2D.c 
	${MKDIR} -p ${OBJECTDIR}/MPI_Heat_2D
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -include . -include CUDA/common/inc/lcutil.h -include CUDA/common/inc/timestamp.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MPI_Heat_2D/mpi_heat2D.o MPI_Heat_2D/mpi_heat2D.c

${OBJECTDIR}/OpenMP/OpenMP_main.o: OpenMP/OpenMP_main.c 
	${MKDIR} -p ${OBJECTDIR}/OpenMP
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -include . -include CUDA/common/inc/lcutil.h -include CUDA/common/inc/timestamp.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OpenMP/OpenMP_main.o OpenMP/OpenMP_main.c
